...
<html>
    ...
    <body>
         <%
            ...
            String date, spelerscode2change;
            ...
            spelerscode2change = request.getParameter("prevspelerscode");
            
            stdtlst.changeStudent(spelerscode2change, arylist);
        %>
        <div id="nav">
        ...
        <div id="content">
            ...
            <a href="getstudent.jsp?nr=<%=arylist.get(1)%>">Klik hier om terug te gaan.</a>
        </div>
    </body>
</html>
